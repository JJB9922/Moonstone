...
class Camera : public CameraController
{
  ...
  public:
    ...
    {
        m_CameraPos += m_CameraSpeed * time.GetDeltaTime() * m_CameraFront;
    }
    ...
    {
        return glm::normalize(m_CameraUp);
    }

    inline float GetPitch() const override
    {
        return m_CameraPitch;
    }
    inline float GetYaw() const override
    {
        return m_CameraYaw;
    }
    inline float GetFov() const override
    {
        return m_CameraFov;
    }
    ...
    inline glm::vec3 GetDirection() const override
    {
        return m_CameraDirection;
    }

    inline bool GetConnected() const override
    {
        return m_CameraConnected;
    }

    void SetProjectionMatrix(int winWidth, int winHeight, float nearClip, float farClip);
    void SetViewMatrix();
    ...
    void SetYaw(const float &yaw) override
    {
        m_CameraYaw = yaw;
    }
    ...
    void SetConnected(const bool &isConnected) override
    {
        m_CameraConnected = isConnected;
    }
